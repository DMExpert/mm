...
(2, 'Devendar Tomar', 'dev@gmail.com', 8802537803, '2019-03-01', 'Expertise in repairing all types of household products'),
(3, 'Ritesh', 'ritesh@gmail.com', 9999608074, '01-03-2019', 'Fix all the product related issues with their expertise');
...
(3, 'Television', 'samsung', '2019-03-01', '2019-03-28', 'ABCD1234', 2000, 8880554878, 'madanpur khadar', 'not working', '', '', ''),
(7, 'Laptop', 'samsung', '2019-03-01', '2019-03-29', 'ABCD1234', 30000, 8802537803, 'Madanpur Khadar Sarita Vihar', 'not working', '', '', ''),
(9, 'Laptop', 'HP', '2015-04-17', '2015-04-30', 'HPI3880253', 27998, 8802537803, 'Madanpur Khadar Sarita Vihar New Delhi', 'My laptop is not working', 'shah@gmail.com', 'Ritesh', '8802537803'),
(12, 'Room Heater', 'LG', '2019-04-12', '2019-04-27', 'SADG45', 362112, 8802537033, 'MADANPUR KHADAR', 'NOT WORKING', 'shah@gmail.com', '', '');
...
(48, 'Shahbaz Ansari', '1996-01-26', '1', 'shah@gmail.com', 1, 8802537803, 'H.NO. 196, NEW PRIYANKA CAMP, MADANPUR KHADAR SARITA VIHAR', '12345', 'user'),
(55, 'Admin', '1996-10-28', 'M', 'admin@gmail.com', 91, 9999806047, 'House No 13 Madanpur Khadar Sarita Vihar New Delhi', '12345', 'admin'),
(56, 'Ritesh Kumar', '2019-03-01', 'M', 'ritesh@gmail.com', 91, 9977656592, 'Aali Gaav', '12345', 'user'),
(57, 'Abhay Singh', '2019-01-01', 'M', 'abhay@gmail.com', 91, 9963214587, 'Sarita Vihar', '12345', 'user'),
(58, 'Amresh', '2017-01-17', 'M', 'amresh@gmail.com', 91, 9966332145, 'Aali Gaav', '12345', 'user'),
(59, 'Anirudh', '2019-03-01', 'M', 'anirudh@gmail.com', 91, 9966321458, 'Madanpur Khadar', '9999', 'user');
...
(4, 'Shahbaz Ansari', 9999806047, 'AC', 'My AC is not working.', '30-03-2019'),
(5, 'Shahbaz Ansari', 8802537803, 'Laptop', 'My laptop not working', '30-03-2019');
...
(19, 'Laptop', 'Household', 'shah@gmail.com', '2019-03-01', '2019-04-06', 'HP12345', 32000, 'MADANPUR KHADAR', 3000, 'Offline Mode', '05-04-2019', '1 Year');
